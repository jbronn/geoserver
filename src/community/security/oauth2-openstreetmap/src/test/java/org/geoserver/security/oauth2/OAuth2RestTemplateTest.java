...
import org.geoserver.security.oauth2.services.OpenStreetMapTokenServices;
...
public class OAuth2RestTemplateTest extends AbstractOAuth2RestTemplateTest {
    ...
    public void open() throws Exception {
        configuration = new OpenStreetMapOAuth2SecurityConfiguration();
    ...
    class MockOpenStreetMapTokenServices extends OpenStreetMapTokenServices {

        final String accessToken;

        public MockOpenStreetMapTokenServices(String accessToken) {
